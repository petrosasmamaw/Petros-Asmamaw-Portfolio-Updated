  ...
  return (
    <section id="certificates" className="py-24">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-5xl font-heading font-black mb-16 text-slate-900 dark:text-white">Resume & Certificates</h2>
          ...
          {CERTIFICATES.map((cert, i) => {
            ...
            return (
              <motion.div
                ...
                className="group glass rounded-[2.5rem] overflow-hidden border-slate-300 dark:border-white/5 flex flex-col h-full"
              >
