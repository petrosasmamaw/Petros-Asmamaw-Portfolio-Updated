...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="glass rounded-[2.5rem] overflow-hidden border-slate-300 dark:border-white/5 flex flex-col h-full group">
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm mb-6 leading-relaxed flex-grow">{project.description || project.desc}</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <a href={project.githubLink || project.github || '#'} target="_blank" rel="noopener noreferrer" className="py-3 bg-white/5 hover:bg-white/10 text-slate-900 dark:text-white rounded-xl text-center text-sm font-bold border border-slate-300 dark:border-white/5 flex items-center justify-center gap-2">
